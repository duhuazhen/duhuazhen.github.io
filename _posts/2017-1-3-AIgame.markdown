...
game.run()
```
将上述代码保存为pygame.py，运行  
```python
python pygame.py

```
会产生__pycache__文件夹，进入并运行  
```python
 python pygame.cpython-35.pyc 
```
自制的垃圾游戏。
操作：按住鼠标左键左移棒子，按住鼠标右键右移棒子。每次接住小方块得一分。

### 基于强化学习的AI（TensorFlow）
我的环境：ubuntu14.04+python3.5+anaconda+pygame+opencv3.1
``` python
import pygame
import random
from pygame.locals import *
...
参考：[https://www.nervanasys.com/openai/](https://www.nervanasys.com/openai/)  
OpenAI文档：[https://gym.openai.com/docs](https://gym.openai.com/docs)  
OpenAI源代码：[https://github.com/openai/gym](https://github.com/openai/gym) 

![强化学习模型](https://upload-images.jianshu.io/upload_images/11573595-c26d1bfaad9c3c04.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
强化学习模型
